...
pub fn kalman_filter_estimate_position_with_velocity_example() {
    // Setup simulation & data logging; inputs based on textbook example
    const DT: f64 = 0.1;
    let times_s: Vec<f64> = ascending_float_range(0.0, 10.0, DT);
    ...
    let plot_labels = PlotLabels {
        plot_pathname: "./plots/05c_KalmanFilter_PosWithVel.png".to_string(),
        title: "Kalman Filter".to_string(),
        x_axis_label: "Time [s]".to_string(),
        y_axis_label: "Speed [m/s]".to_string(),
        y_axis_data1_label: "Measurements".to_string(),
    ...
    let plot_labels = PlotLabels {
        plot_pathname: "./plots/05d_KalmanFilter_PosWithVel.png".to_string(),
        title: "Kalman Filter".to_string(),
        x_axis_label: "Time [s]".to_string(),
        y_axis_label: "Position [m]".to_string(),
        y_axis_data1_label: "Measurements".to_string(),
...
pub fn kalman_filter_measure_velocity_with_sonar_example() {
    ...
    if let Some(sonar_alt_arr) = mat_file.find_by_name("sonarAlt") {
        ...
        let plot_labels = PlotLabels {
            plot_pathname: "./plots/05e_KalmanFilter_VelWithSonar.png".to_string(),
            title: "Kalman Filter".to_string(),
            x_axis_label: "Time [s]".to_string(),
            y_axis_label: "Distance [m]".to_string(),
            y_axis_data1_label: "Measurements".to_string(),
            y_axis_data2_label: "Kalman Filter".to_string(),
        };
        ...
        let mut chart = ChartBuilder::on(&root)
            ...
            .x_label_area_size(50)
            .y_label_area_size(50)
            .build_cartesian_2d(0f64..10f64, 0f64..120f64)
            .expect("ChartBuilder failed");
